...
from nmosquery.v1_0 import query
 ...
 u'node': {u'createdIndex': 6068,
           ...
           u'nodes': [{u'createdIndex': 6068,
                       ...
                       u'nodes': [{u'createdIndex': 6074,
                                   ...
                                   u'value': u'{"href": "http://127.0.0.1:1234/path", "id": "efee1ab5-85f1-4ae3-b5d5-3ccc79ae76af", "label": "test_node", "services": []}'},
                                  {u'createdIndex': 6076,
                                   u'key': u'/resource/nodes/90461aaa-a45a-48f0-ba2e-de51b45ce4ce',
                                   u'modifiedIndex': 6076,
                                   u'value': u'{"href": "http://127.0.0.1:1234/path",  "id": "90461aaa-a45a-48f0-ba2e-de51b45ce4ce", "label": "test_node", "services": [{"type": "urn:x-nmos-opensourceprivatenamespace:service:mdnsbridge/v1.0"}]}'},
                                  {u'createdIndex': 6077,
                                   u'key': u'/resource/nodes/007ff4e5-fe72-4c4b-b858-4c5f37dff946',
                                   u'modifiedIndex': 6077,
                                   u'value': u'{"href": "http://172.29.176.88:12345/", "id": "007ff4e5-fe72-4c4b-b858-4c5f37dff946", "label": "ap-ch-z420-2.rd.bbc.co.uk", "services": [{"type": "urn:x-nmos-opensourceprivatenamespace:service:pipelinemanager/v1.0"}]}'}]}]}}
